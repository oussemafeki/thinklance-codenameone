...
public class ParticiperService {
     public void Participer(Participer p) {
        ConnectionRequest con = new ConnectionRequest();// création d'une nouvelle demande de connexion
        String Url = "http://localhost/ThinkLance/web/app_dev.php/participer?event="+p.getIdevent()+"&user="+ p.getIdadmin();// création de l'URL
      ...
      public ArrayList<Participer> parseListParticiper(String json) {
        ...
        try {
            ...
            */
            ...
            for (Map<String, Object> obj : list) {
                ...
                p.setId((int) id);
                p.setIdadmin((int) user);
                p.setIdevent((int) event);
    ...
    ArrayList<Participer> listpar = new ArrayList<>();
       public ArrayList<Participer> getList3(){       
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/ThinkLance/web/app_dev.php/participerc");  
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                ParticiperService ser = new ParticiperService();
                listpar = ser.parseListParticiper(new String(con.getResponseData()));
            }
        });
